...
def qa_args():
    ...
    parser.add_argument(
        "--dev_global_path",
        default="/home1/deokhk_1/research/FR_with_rank/data_ottqa/dev_global.json",
        type=str,
        help="Path to the dev global json file"
    )
    parser.add_argument(
            "--resource_dir",
            type=str,
    ...
    parser.add_argument("--do_eval_global", action="store_true", default=True, help="Whether to run eval on the dev-global set.")
    ...
    parser.add_argument("--add_special_tokens", action="store_true", default=True, help="whether to add special tokens")
    ...
    parser.add_argument("--eval_steps", type=int, default=-1, help="Save checkpoint every X updates steps.")
    ...
    parser.add_argument("--run_name", type=str, default="qa", help="Wandb run name")
