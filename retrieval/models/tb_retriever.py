...
class SingleRetrieverThreeCatPool(nn.Module):
    def __init__(self, config, args, resized_token_len=None):
        ...
        if resized_token_len is not None:
            self.encoder.resize_token_embeddings(resized_token_len)
        ...
        if not self.shared_encoder:
            ...
            if resized_token_len is not None:
                self.encoder_q.resize_token_embeddings(resized_token_len)
...
class RobertaSingleRetrieverThreeCatPool(SingleRetrieverThreeCatPool):
    ...
    def __init__(self, config, args, resized_token_len=None):
        super(RobertaSingleRetrieverThreeCatPool, self).__init__(config, args, resized_token_len)
